...
<template>
  <div class="space-y-4 py-8 px-4">
    ...
    <div
      class="rounded space-y-4 bg-gray-200 p-4 items-center md:(flex space-y-0 space-x-4) dark:(bg-slate-800 text-gray-200)"
    >
      <div>
        <SmartImage
...
button {
  @apply rounded cursor-pointer bg-gray-200 py-2 px-4 transition-colors text-gray-900 select-none dark:(bg-slate-800 text-gray-100 hover:bg-slate-700) hover:bg-gray-300 focus:outline-none;
}
</style>
