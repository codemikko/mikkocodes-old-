...
module.exports.__inject__ = function (context) {
  add("882dfa80", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_windicss_webpack_plugin_dist_loaders_windicss_style_pitcher_cjs_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_windicss_webpack_plugin_dist_loaders_windicss_template_cjs_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_e05bfa6e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(136);
/* harmony import */ var _node_modules_windicss_webpack_plugin_dist_loaders_windicss_style_pitcher_cjs_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_windicss_webpack_plugin_dist_loaders_windicss_template_cjs_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_e05bfa6e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_windicss_webpack_plugin_dist_loaders_windicss_style_pitcher_cjs_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_windicss_webpack_plugin_dist_loaders_windicss_template_cjs_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_e05bfa6e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_windicss_webpack_plugin_dist_loaders_windicss_style_pitcher_cjs_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_windicss_webpack_plugin_dist_loaders_windicss_template_cjs_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_e05bfa6e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_windicss_webpack_plugin_dist_loaders_windicss_style_pitcher_cjs_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_windicss_webpack_plugin_dist_loaders_windicss_template_cjs_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_e05bfa6e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".description-link[data-v-e05bfa6e]{--tw-border-opacity:1;--tw-border-opacity:0.5;border-bottom-width:2px;border-color:rgba(100,116,139,.5);border-color:rgba(100,116,139,var(--tw-border-opacity))}.description-link[data-v-e05bfa6e]:hover{--tw-border-opacity:0.75}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/pages/index.vue?vue&type=template&id=e05bfa6e&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c,
    _setup = _vm._self._setupProxy;
  return _c('div', {
  ...
  }, [_vm._ssrNode("<header class=\"rounded-md flex flex-col-reverse my-16 mx-4 py-10 justify-between md:flex-row md:items-center\" data-v-e05bfa6e>", "</header>", [_vm._ssrNode("<div class=\"md:w-8/12\" data-v-e05bfa6e>", "</div>", [_vm._ssrNode("<div class=\"space-y-2\" data-v-e05bfa6e>", "</div>", [_vm._ssrNode("<div class=\"font-semibold text-xl text-slate-700 md:text-3xl dark:text-slate-200\" data-v-e05bfa6e>", "</div>", [_vm._ssrNode("<h1 data-v-e05bfa6e>Self taught</h1> "), _vm._ssrNode("<h1 data-v-e05bfa6e>", "</h1>", [_c('SmartLink', {
    staticClass: "cursor-help border-b-2 border-blue-700 text-blue-700 dark:border-slate-500 dark:text-slate-500",
    attrs: {
      "href": "https://www.w3schools.com/whatis/whatis_fullstack_js.asp",
      "blank": ""
    }
  }, [_vm._v("Full-stack")]), _vm._ssrNode("\n            web developer\n          ")], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<p class=\"text-slate-500\" data-v-e05bfa6e>", "</p>", [_vm._ssrNode("\n          Hi there, my name is Abdulbaki, I am from Turkey and I am a self\n          taught web developer. I build complex web apps using frameworks such\n          as\n          "), _c('SmartLink', {
    ...
    staticClass: "mt-4"
  })], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"rounded-full mb-4 md:mb-0\" data-v-e05bfa6e>", "</div>", [_c('SmartImage', {
    staticClass: "rounded-full h-30 w-30 md:h-40 md:w-40",
    attrs: {
      "src": "/assets/images/memoji.png"
    }
  })], 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section id=\"pages\" class=\"my-16\" data-v-e05bfa6e>", "</section>", [_c('Title', [_vm._v("Pages")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"mt-4 grid gap-4 md:grid-cols-2\" data-v-e05bfa6e>", "</div>", _vm._l(_vm.cards.pages, function (card, index) {
    return _c('Card', {
      key: `card-p-${index}`,
      attrs: {
        "title": card.title,
  ...
  }), 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section id=\"me\" class=\"my-16\" data-v-e05bfa6e>", "</section>", [_c('Title', [_vm._v("Me")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"mt-4 grid gap-4 md:grid-cols-2\" data-v-e05bfa6e>", "</div>", _vm._l(_vm.cards.me, function (card, index) {
    return _c('Card', {
      key: `card-m-${index}`,
      attrs: {
        "title": card.title,
  ...
  }), 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section id=\"projects\" data-v-e05bfa6e>", "</section>", [_c('Title', [_vm._v("Projects I currently work on")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"mt-4 grid gap-2 md:gap-4 md:grid-cols-2\" data-v-e05bfa6e>", "</div>", _vm._l(_vm.projects, function (project, index) {
    return _c('Card', {
      key: `project-${index}`,
      staticClass: "h-full",
      attrs: {
      ...
      scopedSlots: _vm._u([project.icon ? {
        ...
        fn: function () {
          return [_c('IconDev', {
            staticClass: "rounded-full bg-gray-100 h-14 p-2 text-slate-500 w-14 dark:bg-slate-800 dark:text-white",
            attrs: {
              "brand": project.icon
            }
          })];
  ...
  }), 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section id=\"experiences\" class=\"mt-4 grid gap-6 sm:mt-6 md:md:mt-10 md:gap-8 md:grid-cols-2\" data-v-e05bfa6e>", "</section>", [_vm._ssrNode("<div data-v-e05bfa6e>", "</div>", [_vm._ssrNode("<div class=\"flex items-center gap-4 justify-between\" data-v-e05bfa6e>", "</div>", [_c('Title', [_vm._v("Experience")]), _vm._ssrNode(" <button class=\"text-gray-400 mr-4 text-sm hover:underline dark:text-slate-700\" data-v-e05bfa6e>" + _vm._ssrEscape("\n          " + _vm._s(_vm.showExtraExperience ? "show less" : "show more") + "\n        ") + "</button>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"mt-4 grid gap-2\" data-v-e05bfa6e>", "</div>", _vm._l(_vm.experiences.jobs, function (experience, index) {
  ...
  }), 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div data-v-e05bfa6e>", "</div>", [_vm._ssrNode("<div class=\"flex items-center gap-4 justify-between\" data-v-e05bfa6e>", "</div>", [_c('Title', [_vm._v("Education")]), _vm._ssrNode(" <button class=\"text-gray-400 mr-4 text-sm hover:underline dark:text-slate-700\" data-v-e05bfa6e>" + _vm._ssrEscape("\n          " + _vm._s(_vm.showExtraExperience ? "show less" : "show more") + "\n        ") + "</button>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"mt-4 grid gap-2\" data-v-e05bfa6e>", "</div>", _vm._l(_vm.experiences.education, function (experience, index) {
    return _c('CardExperience', {
      directives: [{
        name: "show",
        rawName: "v-show",
  ...
  }), 1)], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section id=\"technologies\" class=\"mt-6\" data-v-e05bfa6e>", "</section>", [_c('Title', [_vm._v("Technologies I use")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"flex flex-col space-y-6 mt-8\" data-v-e05bfa6e>", "</div>", _vm._l(_vm.skills, function (category) {
    return _vm._ssrNode("<section data-v-e05bfa6e>", "</section>", [_vm._ssrNode("<h5 class=\"border-b border-gray-400/10 dark:border-slate-600/10 text-gray-400 dark:text-slate-600/70 text-lg mx-4 mb-4 pb-2 font-medium\" data-v-e05bfa6e>" + _vm._ssrEscape("\n          " + _vm._s(category.title) + "\n        ") + "</h5> "), _vm._ssrNode("<div class=\"grid px-4 md:grid-cols-3 grid-cols-1 lg:grid-cols-4 gap-x-2 gap-y-2\" data-v-e05bfa6e>", "</div>", _vm._l(category.items, function (skill, index) {
...
// CONCATENATED MODULE: ./src/pages/index.vue?vue&type=template&id=e05bfa6e&scoped=true&
