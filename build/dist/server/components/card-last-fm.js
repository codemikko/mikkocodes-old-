...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/components/Card/LastFm.vue?vue&type=template&id=51b51fdd&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c,
    _setup = _vm._self._setupProxy;
  return _c('SmartLink', {
    staticClass: "rounded-md flex space-x-4 p-4 transition-colors focus-ring overflow-x-hidden items-center hover:bg-gray-100 dark:hover:bg-slate-800",
    class: {
    ...
    staticClass: "h-6 text-slate-300 w-6"
  })], 1) : _vm._e()], 1), _vm._v(" "), _c('div', {
    staticClass: "flex flex-col truncate"
  }, [_c('span', {
    staticClass: "text-slate-700 truncate dark:text-slate-400"
...
// CONCATENATED MODULE: ./src/components/Card/LastFm.vue?vue&type=template&id=51b51fdd&
...
installComponents(component, {SmartImage: __webpack_require__(16).default,IconPlay: __webpack_require__(123).default,SmartLink: __webpack_require__(9).default})
