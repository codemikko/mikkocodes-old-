...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/components/Card/Sponsor.vue?vue&type=template&id=0708593a&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c,
    _setup = _vm._self._setupProxy;
  return _c('SmartLink', {
    staticClass: "flex space-x-3 px-4 py-1.5 rounded-md transition-colors hover:bg-gray-200/40 dark:hover:bg-slate-800/40 select-none items-center",
    attrs: {
...
// CONCATENATED MODULE: ./src/components/Card/Sponsor.vue?vue&type=template&id=0708593a&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/pages/donate.vue?vue&type=template&id=c1bc4de0&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c,
    _setup = _vm._self._setupProxy;
  return _c('div', {
    staticClass: "py-4"
  }, [_vm._ssrNode("<div class=\"space-y-12 text-gray-500 sm:w-9/12 dark:text-slate-600\">", "</div>", [_vm._ssrNode("<header class=\"space-y-2 my-12 px-4\"><h1 class=\"text-gray-700 text-4xl dark:text-slate-300\">Donate</h1> <p>\n        If you like my projects and/or what I do and you want to contribute,\n        make me happy, you can donate to me with the information on this page!\n        Thank you ♥\n      </p> <p class=\"text-xs\">\n        P.S. Use &quot;<span class=\"border-b border-black/10 dark:border-white/10\">Hello Mikko</span>&quot; as the name of your transactions.\n      </p></header> "), _vm._ssrNode("<section class=\"space-y-4\">", "</section>", [_c('Title', [_vm._v("Support Me On")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"flex flex-wrap gap-x-4 gap-y-2 mx-4\">", "</div>", [_c('Button', {
    directives: [{
      name: "tippy",
      rawName: "v-tippy",
      value: {
  ...
  }, [_vm._v("\n\n          GitHub Sponsors\n        ")])], 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"space-y-4\">", "</section>", [_c('SmartLink', {
    ...
    return _vm._ssrNode("<div class=\"flex h-full items-center\">", "</div>", [_vm._ssrNode("<div class=\"rounded-l bg-gray-200/75 dark:bg-slate-800/50\">", "</div>", [_c('SmartImage', {
      staticClass: "rounded-l h-24 w-24",
      attrs: {
        "src": account.image
      }
    })], 1), _vm._ssrNode(" <div class=\"rounded-tr rounded-br flex h-full bg-gray-200/50 w-full pl-4 items-center dark:bg-slate-800/75\"><div><h3 class=\"font-medium text-lg text-gray-900 dark:text-slate-300\">" + _vm._ssrEscape("\n                " + _vm._s(account.name) + "\n              ") + "</h3> " + (account.revealed == true ? "<span class=\"text-gray-800 dark:text-slate-500\">" + _vm._ssrEscape("\n                " + _vm._s(account.iban) + "\n              ") + "</span>" : "<span class=\"cursor-pointer text-gray-800 dark:text-slate-500 hover:underline\">\n                Click to reveal\n              </span>") + "</div></div>")], 2);
  }), 0)], 2)], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./src/pages/donate.vue?vue&type=template&id=c1bc4de0&
...
/* harmony default export */ var donatevue_type_script_lang_ts_ = (external_vue_default.a.extend({
  ...
  async fetch() {
    const {
      data
    } = await this.$axios.get("https://raw.githubusercontent.com/codemikko/.github/main/sponsors.json");
    this.sponsors = data;
  },
  head() {
    const title = "Donate";
...
/* nuxt-component-imports */
installComponents(component, {Title: __webpack_require__(95).default,IconBrand: __webpack_require__(101).default,Button: __webpack_require__(10).default,SmartLink: __webpack_require__(9).default,SkeletonLoader: __webpack_require__(94).default,CardSponsor: __webpack_require__(138).default,SmartImage: __webpack_require__(16).default})
